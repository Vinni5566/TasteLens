...
A **minimal web interface** was built to display recommendations, allowing users to **browse popular dishes** and see **personalized suggestions** generated by the ML models.
